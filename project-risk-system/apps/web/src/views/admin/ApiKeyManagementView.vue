...
<template>
  <AdminShell>
    ...
    <section class="prototype-security-banner"><span>锁</span><div><strong>DeepSeek Official only</strong><p>Company API、自定义 endpoint、Authorization 和明文 key 均不进入前端 contract。</p></div></section>
