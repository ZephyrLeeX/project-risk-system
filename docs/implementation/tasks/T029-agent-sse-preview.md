...
- **Authoritative source references:** ADRs 0019/0020; T008 worker boundary; T028 tools; `project-risk-system/apps/web/src/views/DashboardView.vue`.
- **Relevant ADR IDs:** 0005, 0006, 0011, 0013, 0014, 0016, 0019, 0020.
- **Dependencies:** T004, T007, T008, T010, T014, T028.
- **Scope:** Provider orchestration through ADR 0020, intent/arguments validation, ADR 0019 SSE framing/IDs, disconnect/timeout/resume behavior, structured preview/token issue boundary.
...
- **Validation:** ASGI streaming integration tests plus the ADR 0020-approved Worker/Provider boundary using a fake Provider.
