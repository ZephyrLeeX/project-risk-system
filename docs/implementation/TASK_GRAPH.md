...
| 25 | T038 | DG-05 resolved by ADR 0032; numeric capacity/reliability thresholds now approved. T038 READY pending explicit Wave 25 start. |
...
| T038 | READY (DG-05 resolved by ADR 0032) | T037 | Validate performance and resilience at the approved capacity baseline. |
| T039 | BLOCKED_EXTERNAL_INPUTS (blocked on T038 PASS + external materials); inherited gaps all resolved | T038 | Complete real mailbox/Provider E2E, restore evidence and Python-only cutover. |
