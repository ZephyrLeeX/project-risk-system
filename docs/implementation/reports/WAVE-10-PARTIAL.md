...
T025：`REVIEW_PASSED`。ADR 0024 固定附件安全策略已实施；Independent Review、Ruff、mypy、focused pytest、lock/diff checks 均为 `PASS`。详见 `docs/implementation/reports/T025.md`。
